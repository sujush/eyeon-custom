...
export class LambdaFunctionStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: LambdaFunctionStackProps) {
    ...
    this.api = new apigateway.RestApi(this, 'HsCodeApi', {
      ...
      description: 'API for HS Code Automation System',
    ...
    // 엑셀 파일 처리 Lambda 함수
    const processExcelFunction = new lambda.Function(this, 'ProcessExcelFunction', {
      functionName: 'process-excel',
      runtime: lambda.Runtime.NODEJS_18_X,
      handler: 'index.handler',
      code: lambda.Code.fromAsset('dist/lambda/processExcel'),
    ...
    // 제품 관리 Lambda 함수
    const productManagementFunction = new lambda.Function(this, 'ProductManagementFunction', {
      functionName: 'product-management',
      runtime: lambda.Runtime.NODEJS_18_X,
      handler: 'index.handler',
      code: lambda.Code.fromAsset('dist/lambda/productManagement'),
